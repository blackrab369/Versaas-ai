/**
 * Zero-to-One Virtual Software Inc. - Professional UI/UX Animations
...
class EnterpriseAnimations {
    ...
    createEnhancedTooltip(content, position = 'top') {
        ...
        tooltip.className = 'enterprise-tooltip absolute z-50 glass-effect p-3 rounded-lg text-sm max-w-xs';
